...
describe Compiler do
  ...
  it 'compiles method definitions' do
    ...
    expect(compile(code)).must_equal_with_diff [
                             ...
                             { type: 'String', instruction: :call, name: :foo, arg_count: 0 },
                             { type: 'NilClass', instruction: :pop },
                             { type: 'Object', instruction: :push_self },
                             { type: 'Integer', instruction: :call, name: :bar, arg_count: 0 },
                           ]
  end
    ...
    expect(compile(code)).must_equal_with_diff [
                             ...
                             },
                             {
                               ...
                               body: [
                                 ...
                                 { type: 'Integer', instruction: :call, name: :bar, arg_count: 1 },
                               ],
                             },
                             { type: 'Object', instruction: :push_self },
                             { type: 'String', instruction: :push_str, value: 'foo' },
                             { type: 'Integer', instruction: :push_int, value: 1 },
                             { type: 'String', instruction: :call, name: :foo, arg_count: 2 },
                             { type: 'NilClass', instruction: :pop },
                             { type: 'Object', instruction: :push_self },
                             { type: 'Integer', instruction: :push_int, value: 2 },
                             { type: 'Integer', instruction: :call, name: :bar, arg_count: 1 },
                             ...
                             { type: 'Integer', instruction: :call, name: :baz, arg_count: 1 },
                           ]
  end
  ...
  it 'compiles operator expressions' do
    ...
    expect(compile(code)).must_equal_with_diff [
                             ...
                             { type: 'Integer', instruction: :call, name: :num, arg_count: 1 },
                             { type: 'Integer', instruction: :push_int, value: 2 },
                             { type: 'Integer', instruction: :call, name: :*, arg_count: 1 },
                           ]
  end
  ...
  it 'compiles arrays' do
   ...
   CODE
    expect(compile(code)).must_equal_with_diff [
                             ...
                             { type: 'Integer', instruction: :call, name: :first, arg_count: 0 },
                             { type: 'NilClass', instruction: :pop },
                             ...
                             { type: 'String', instruction: :push_str, value: 'foo' },
                             { type: 'Array[String]', instruction: :call, name: :<<, arg_count: 1 },
                             { type: 'NilClass', instruction: :pop },
                             { type: 'Array[String]', instruction: :push_var, name: :b },
